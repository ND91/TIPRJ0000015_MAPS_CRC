...
discard_cellIDs <- unique(c(grep("multiplet", seuratObject@meta.data$manual_l4, ignore.case = T), 
                            ...
                            grep("endothelial", seuratObject@meta.data$manual_l4, ignore.case = T),
                            grep("epithelial", seuratObject@meta.data$manual_l4, ignore.case = T),
                            grep("mesenchymal", seuratObject@meta.data$manual_l4, ignore.case = T),
                          ))
