---
title: 'Figure 4: Peritoneal-resident immunosuppressive macrophages infiltrate PMs'
...
pdf(file.path(fig4Dir, "dotplot_gex_crcpmp_tx_macrophages_colchemotaxisreceptors.pdf"), width = 1.7, height = 4.5)
...
pdf(file.path(fig4Dir, "radarplot_crcpmp_pf_tx_macrophages_mediantamclassification.pdf"), width = 5, height=5.5)
...
pdf(file.path(fig4Dir, "dotplot_crcpmp_tx_macrophages_coltammarkers.pdf"), width = 7, height=2.75)
