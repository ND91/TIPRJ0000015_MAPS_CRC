...
Here we calculate the Pearson correlation coefficients between gene expression and protein expression per lineage. This data was added post-hoc to the visualization. 
...
marker_gex_pex_mean %>%
  ...
  write_delim(file.path(figS1Dir, "hc_pf_cellmarkers_pex_gex_overlapping_lm_pearson.csv"), delim = ",")
```
