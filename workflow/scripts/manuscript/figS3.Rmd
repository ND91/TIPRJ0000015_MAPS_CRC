...
marker_gex <- GetAssayData(seurat_crcpmp_tx_immune, assay = "RNA")[which(rownames(GetAssayData(seurat_crcpmp_tx_immune, assay = "RNA")) %in% unique(marker_genes_wvsig4$FeatureID)), ]
