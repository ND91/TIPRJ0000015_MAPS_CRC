---
title: 'Figure S4: Celltype annotation'
...
seurat_crc_pf_rds <- file.path(base_path, "output/q1_pf_characterization/subsets/hc_pf_SeuratObject.Rds")
seurat_crc_pf_mnp_rds <- file.path(base_path, "output/q1_pf_characterization/subsets/hc_pf_MNP_SeuratObject.Rds")
seurat_crc_pf_macrophages_rds <- file.path(base_path, "output/q1_pf_characterization/subsets/hc_pf_macrophages_SeuratObject.Rds")
...
### UMAP HC CRC PF colored by lineage markers
