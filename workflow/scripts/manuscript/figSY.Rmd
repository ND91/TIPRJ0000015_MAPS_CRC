...
```{r dotplot colon col_l2, fig.width = 7.25, fig.height=15}
marker_genes <- readxl::read_excel(pf_heatmap_order_xlsx) %>%
  dplyr::filter(Assay == "RNA")
marker_gex <- GetAssayData(seurat_colon, assay = "RNA")[which(rownames(GetAssayData(seurat_colon, assay = "RNA")) %in% unique(marker_genes$FeatureID)), ]

dotplot_colon_l2_cellmarkers_gex_ggplotobj <- data.frame(FeatureID = rownames(marker_gex), marker_gex) %>%
...
pdf("dotplot_colon_l2_cellmarkers_gex_ggplotobj.pdf", width = 3.75, height=15)
print(dotplot_colon_l2_cellmarkers_gex_ggplotobj)
dev.off()
```

### UMAP colon colored by lineage genes

```{r umap colon col_lineage_markers, fig.width=10, fig.height=3}
...
pdf("umap_colon_collineagegenemarkers_colviridis.pdf", width = 10, height = 3)
print(ggarrange(plotlist = umap_colon_collineagegenemarkers_ggplotobj_list, nrow = 1, ncol = 4))
dev.off()
```

### UMAP colon mononuclear phagocytes colored by marker genes

```{r umap colon col_myeloidgenemarkers}
umap_colon_myeloid_colmyeloidgenemarkers_ggplotobj_list <- lapply(
  data.frame(CB = colnames(seurat_colon_myeloid),
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["CLEC9A",],
                                  Feature = "CLEC9A")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["SPP1",],
                                  Feature = "SPP1")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["VCAN",],
                                  Feature = "VCAN")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["C1QA",],
                                  Feature = "C1QA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["VSIG4",],
                                  Feature = "VSIG4")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["TREM2",],
                                  Feature = "TREM2")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["FN1",],
                                  Feature = "FN1")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["CSF1R",],
                                  Feature = "CSF1R")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["ITGAX",],
                                  Feature = "ITGAX")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["TIMD4",],
                                  Feature = "TIMD4")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["MRC1",],
                                  Feature = "MRC1")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["LYVE1",],
                                  Feature = "LYVE1")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_myeloid ),
                                  Embeddings(seurat_colon_myeloid[["umap"]]),
                                  seurat_colon_myeloid@meta.data,
                                  expr = GetAssayData(seurat_colon_myeloid,  layers = "data")["S100A8",],
                                  Feature = "S100A8")) %>%
    dplyr::mutate(expr_rank = rank(expr, ties.method="first"),
...
print(ggarrange(plotlist = umap_colon_myeloid_colmyeloidgenemarkers_ggplotobj_list, nrow = 5, ncol = 5))

pdf("umap_colon_myeloid_colmyeloidgenemarkers_colviridis.pdf", width = 15, height = 15)
print(ggarrange(plotlist = umap_colon_myeloid_colmyeloidgenemarkers_ggplotobj_list, nrow = 5, ncol = 5))
dev.off()
```

### UMAP colon macrophages colored by marker genes

```{r umap colon macrophages col_myeloidgenemarkers, fig.width=12, fig.height=12}
umap_colon_macrophages_colmyeloidgenemarkers_ggplotobj_list <- lapply(
  data.frame(CB = colnames(seurat_colon_macrophages ),
             ...
             expr = GetAssayData(seurat_colon_macrophages, layers = "data")["CD1C",],
             Feature = "CD1C",
             Modality = "RNA") %>%
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["MARCO",],
                                  Feature = "MARCO",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["VSIG4",],
                                  Feature = "VSIG4",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["TREM2",],
                                  Feature = "TREM2",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["FN1",],
                                  Feature = "FN1",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["CSF1R",],
                                  Feature = "CSF1R",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["ITGAM",],
                                  Feature = "ITGAM",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["ITGAX",],
                                  Feature = "ITGAX",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["CD14",],
                                  Feature = "CD14",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["TIMD4",],
                                  Feature = "TIMD4",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["MRC1",],
                                  Feature = "MRC1",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["LYVE1",],
                                  Feature = "LYVE1",
                                  Modality = "RNA")) %>%
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
    ...
    dplyr::rows_append(data.frame(CB = colnames(seurat_colon_macrophages ),
                                  Embeddings(seurat_colon_macrophages[["umap"]]),
                                  seurat_colon_macrophages@meta.data,
                                  expr = GetAssayData(seurat_colon_macrophages, layers = "data")["S100A8",],
                                  Feature = "S100A8",
                                  Modality = "RNA")) %>%
    dplyr::mutate(expr_rank = rank(expr, ties.method="first"),
...
print(ggarrange(plotlist = umap_colon_macrophages_colmyeloidgenemarkers_ggplotobj_list, nrow = 5, ncol = 5))

pdf("umap_colon_macrophages_colmyeloidgenemarkers_colviridis.pdf", width = 15, height = 15)
print(ggarrange(plotlist = umap_colon_macrophages_colmyeloidgenemarkers_ggplotobj_list, nrow = 5, ncol = 5))
dev.off()
```