...
pdf(file.path(fig3Dir, "umap_hc_crcpmp_pbmc_pf_tx_monocytes_macrophages_coll2.pdf"), width = 7.5, height = 7.5)
...
pdf(file.path(fig3Dir, "umap_hc_crcpmp_pbmc_pf_tx_monocytes_macrophages_coltissuegroup.pdf"), width = 7.5, height = 7.5)
...
pdf(file.path(fig3Dir, "heatmap_hc_crcpmp_pbmc_pf_tx_monocytes_macrophages_coleucdist.pdf"), width = 14, height = 12)
...
pdf(file.path(fig3Dir, "dendrogram_hclust_dist_rld_tissue_group_circular_ptcol.pdf"), width = 10, height = 10)
