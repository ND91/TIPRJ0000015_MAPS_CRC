...
crc_umap_myeloid_pbmc_pf_colcelltype_splittissue_pdf <- args[4]
...
crc_umap_pbmc_pf_colcelltype_splittissue <- umap_df %>% 
...
pdf(width = 10, height = 6, file = crc_umap_myeloid_pbmc_pf_colcelltype_splittissue_pdf)
print(crc_umap_pbmc_pf_colcelltype_splittissue)
dev.off()
