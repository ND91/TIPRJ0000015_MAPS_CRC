...
# The goal of this script is to select the macrophages from HC patients.
...
seuratObject <- RunPCA(object = seuratObject, npcs = 100, seed.use = 63411346)
...
seuratObject <- RunUMAP(seuratObject, dims = 1:50, seed.use = 721273)
