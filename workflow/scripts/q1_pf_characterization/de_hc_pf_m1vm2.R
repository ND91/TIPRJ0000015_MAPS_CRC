...
# This script will perform the differential expression analyses comparing M1 with M2 from PF.
...
seuratObject_macrophage <- seuratObject[,seuratObject@meta.data$manual_l3 %in% c("M1-like", "M2-like")]
